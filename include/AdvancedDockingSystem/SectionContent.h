...
public:
  ...
  /*!
   * Creates new content, associates it to <em>container</em> and takes
   * ownership of <em>title</em>- and <em>content</em>- widgets. \param
   * uniqueName An unique identifier across the entire process. \param container
   * The parent ContainerWidget in which this content will be active. \param
   * title The widget to use as title. \param content The widget to use as
   * content. \return May return a invalid ref-pointer in case of invalid
   * parameters.
   */
