...
public:
  ...
  int indexOfContentByTitlePos(const QPoint& pos,
                               QWidget* exclude = NULL) const;
...
private:
  ...
  int _tabsLayoutInitCount;  // used for calculations on _tabsLayout
                             // modification calls.
...
{
public:
  SectionWidgetTabsScrollArea(SectionWidget* sectionWidget,
                              QWidget* parent = NULL);
