    ...
    , _contentWidget(contentWidget)
{
  ...
  if (sc->flags().testFlag(SectionContent::Closeable)) {
    ...
    QObject::connect(closeButton,
                     &QPushButton::clicked,
                     this,
                     &FloatingWidget::onCloseButtonClicked);
#else
    QObject::connect(
        closeButton, SIGNAL(clicked(bool)), this, SLOT(onCloseButtonClicked()));
#endif
  }
...
{
  _container->_floatings.removeAll(this);  // Note: I don't like this here, but
